##############################################################################################
# Lateral Movement Atomic Tests - da eseguire con powershell, senza privilegi di admin
##############################################################################################

# Configurazioni
$AtomicPath = "C:\Temp\Mead\atomic-red-team-master\atomic-red-team-master\atomics"
$LogDir = "C:\Temp\Mead\AtomicLogs\LateralMovement_NotAdmin"
$ReportPath = Join-Path $LogDir "LateralMovementNotAdmin_Report.csv"
...
$testsToRun = @(
        ...
        @{ Technique = "T1550.002"; TestNumber = 1 }
        @{ Technique = "T1550.002"; TestNumber = 2 }
        @{ Technique = "T1550.003"; TestNumber = 1 }
        @{ Technique = "T1021.001"; TestNumber = 1 }
        @{ Technique = "T1091"; TestNumber = 1 }
        @{ Technique = "T1021.002"; TestNumber = 1 }
        @{ Technique = "T1021.002"; TestNumber = 2 }
        @{ Technique = "T1021.006"; TestNumber = 2 }
)
