...
### 3. Scarica e configura la repository Atomic Red Team
...
2. Estrai il contenuto del file ZIP all'interno di una cartella messa in esclusione sull'antivirus.
3. Verifica: dopo aver estratto la zip, dovresti trovare nella cartella il contenuto all'interno della cartella, all'interno di **PATH_TO_THE_FOLDER\atomic-red-team-master**.
...
### 4. Aggiungi lo script PowerShell per l'esecuzione dei test
